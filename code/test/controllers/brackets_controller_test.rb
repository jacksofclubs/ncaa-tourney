...
class BracketsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bracket" do
    assert_difference('Bracket.count') do
      post brackets_url, params: { bracket: { active: @bracket.active, round_of_tourny: @bracket.round_of_tourny } }
    end
  ...
  test "should update bracket" do
    patch bracket_url(@bracket), params: { bracket: { active: @bracket.active, round_of_tourny: @bracket.round_of_tourny } }
